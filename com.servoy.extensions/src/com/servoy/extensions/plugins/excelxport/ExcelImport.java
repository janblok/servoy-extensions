 ...
 * @author	jblok
*/
public class ExcelImport extends WizardWindow
{
/*
 ...
 */
	public ExcelImport(IApplication app) throws RepositoryException
	{
	...
	protected void createPanels() throws Exception
	{
		...
		addPanel(new ImportSelectSheetPanel(this, getState()));
