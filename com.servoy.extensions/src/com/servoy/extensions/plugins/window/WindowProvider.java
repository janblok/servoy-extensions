	...
	public void shortcutHit(KeyStroke key, IComponent component, String formName)
	{
		...
		if (globalHandler != null)
		{
			try
			{
				...
				ret = globalHandler.functionDefinition.execute(plugin.getClientPluginAccess(), new Object[] { event }, false);
			}
			catch (Exception e)
			{
		...
		if (formHandler != null)
		{
			...
			else
			{
				try
				{
					...
					formHandler.functionDefinition.execute(plugin.getClientPluginAccess(), new Object[] { event }, false);
				}
				catch (Exception e)
				{
