...
public class MapSerializer 
{
	public static Map<String,Object> convertToMap(Object jsobj)
	{
		...
		if (jsobj == null || jsobj == Undefined.instance || jsobj instanceof IFoundSet 
				|| jsobj instanceof IRecord || !(jsobj instanceof NativeObject))
		{
			return retval;
		}
	...
	private static class JSMap extends HashMap<String, Object> implements JSConvertedMap<String, Object>
	{
